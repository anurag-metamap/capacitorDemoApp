...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2" xmlns:ns2="http://schemas.android.com/tools">
    ...
    <color name="metamap_background_color_dark">#000000</color>
    <color name="metamap_background_color_light">#FFFFFF</color>
    <color name="metamap_black">#000000</color>
    <color name="metamap_color_accent">#8392B8</color>
    <color name="metamap_color_disabled">#9B9C9E</color>
    <color name="metamap_color_red">#FE7581</color>
    <color name="metamap_color_selected">#F0F0F0</color>
    <color name="metamap_cpf_et_hint_color">#EDF0F5</color>
    <color name="metamap_darkGray">#60000000</color>
    <color name="metamap_divider_color">#CBD2E2</color>
    <color name="metamap_green_text">#5AC794</color>
    <color name="metamap_primary_text">#232939</color>
    <color name="metamap_primary_text_inverse">#FFFFFF</color>
    <color name="metamap_secondary_text">#8392B8</color>
    <color name="metamap_tint_color">#8392B8</color>
    <color name="metamap_view_element">#8392B8</color>
    <color name="metamap_white">#FFFFFF</color>
    ...
    <dimen name="mm_button_corner_radius">6dp</dimen>
    <dimen name="mm_button_min_height">64dp</dimen>
    <dimen name="mm_main_button_bottom_margin">20dp</dimen>
    <dimen name="mm_symbol_view_corner_radius">2dp</dimen>
    <dimen name="mm_symbol_view_height">48dp</dimen>
    <dimen name="mm_symbol_view_stroke_width">2dp</dimen>
    <dimen name="mm_symbol_view_text_size">22sp</dimen>
    <dimen name="mm_symbol_view_width">42dp</dimen>
    <dimen name="mm_symbols_spacing">8dp</dimen>
    ...
    <string name="metamap_AllowCameraMobileBlock_description">We need to access your camera for recording\na short video.</string>
    <string name="metamap_AllowCameraMobileBlock_title">We can’t get access to camera</string>
    <string name="metamap_AllowCameraMobile_description">To continue, we need to access your camera to record a short video</string>
    <string name="metamap_AllowCameraMobile_title">Please allow access to the camera</string>
    <string name="metamap_AllowMicrophoneMobileBlock_description">We need a microphone to record your voice.</string>
    <string name="metamap_AllowMicrophoneMobileBlock_title">We can’t get access to microphone</string>
    <string name="metamap_AllowMicrophoneMobile_description">We need a microphone to record your voice.</string>
    <string name="metamap_AllowMicrophoneMobile_title">Allow access to microphone</string>
    <string name="metamap_LivenessVoiceCapture_sayDigits">Say these digits in {GB} English or {ES} Spanish</string>
    <string name="metamap_action_camera_permission_denied">Go to settings</string>
    <string name="metamap_allow_locaiton_access">Allow location access</string>
    <string name="metamap_approved_title_label">I hereby expressly authorize</string>
    <string name="metamap_bank_account_title">Bank Account Data</string>
    <string name="metamap_baseErrorScreen_fileMatchError_description">We need both sides of your ID, please take another photo.</string>
    <string name="metamap_baseErrorScreen_fileMatchError_title">You uploaded the same photo twice</string>
    <string name="metamap_can_proceed_verification">You can now proceed with the verification flow.</string>
    <string name="metamap_check_your_internet">Please check your internet</string>
    <string name="metamap_could_not_access_location">We couldn’t access your location.</string>
    <string name="metamap_country_ad">Andorra</string>
    <string name="metamap_country_ae">United Arab Emirates</string>
    <string name="metamap_country_af">Afghanistan</string>
    <string name="metamap_country_ag">Antigua &amp; Barbuda</string>
    <string name="metamap_country_ai">Anguilla</string>
    <string name="metamap_country_al">Albania</string>
    <string name="metamap_country_am">Armenia</string>
    <string name="metamap_country_ao">Angola</string>
    <string name="metamap_country_ar">Argentina</string>
    <string name="metamap_country_as">American Samoa</string>
    <string name="metamap_country_at">Austria</string>
    <string name="metamap_country_au">Australia</string>
    <string name="metamap_country_aw">Aruba</string>
    <string name="metamap_country_az">Azerbaijan</string>
    <string name="metamap_country_ba">Bosnia &amp; Herzegovina</string>
    <string name="metamap_country_bb">Barbados</string>
    <string name="metamap_country_bd">Bangladesh</string>
    <string name="metamap_country_be">Belgium</string>
    <string name="metamap_country_bf">Burkina Faso</string>
    <string name="metamap_country_bg">Bulgaria</string>
    <string name="metamap_country_bh">Bahrain</string>
    <string name="metamap_country_bi">Burundi</string>
    <string name="metamap_country_bj">Benin</string>
    <string name="metamap_country_bm">Bermuda</string>
    <string name="metamap_country_bn">Brunei</string>
    <string name="metamap_country_bo">Bolivia</string>
    <string name="metamap_country_br">Brazil</string>
    <string name="metamap_country_bs">Bahamas</string>
    <string name="metamap_country_bt">Bhutan</string>
    <string name="metamap_country_bw">Botswana</string>
    <string name="metamap_country_by">Belarus</string>
    <string name="metamap_country_bz">Belize</string>
    <string name="metamap_country_ca">Canada</string>
    <string name="metamap_country_cd">Congo - Kinshasa</string>
    <string name="metamap_country_cf">Central African Republic</string>
    <string name="metamap_country_cg">Congo - Brazzaville</string>
    <string name="metamap_country_ch">Switzerland</string>
    <string name="metamap_country_ci">Côte d’Ivoire</string>
    <string name="metamap_country_cl">Chile</string>
    <string name="metamap_country_cm">Cameroon</string>
    <string name="metamap_country_cn">China</string>
    <string name="metamap_country_co">Colombia</string>
    <string name="metamap_country_cr">Costa Rica</string>
    <string name="metamap_country_cu">Cuba</string>
    <string name="metamap_country_cv">Cape Verde</string>
    <string name="metamap_country_cw">Curaçao</string>
    <string name="metamap_country_cy">Cyprus</string>
    <string name="metamap_country_cz">Czech Republic</string>
    <string name="metamap_country_de">Germany</string>
    <string name="metamap_country_dj">Djibouti</string>
    <string name="metamap_country_dk">Denmark</string>
    <string name="metamap_country_dm">Dominica</string>
    <string name="metamap_country_do">Dominican Republic</string>
    <string name="metamap_country_dz">Algeria</string>
    <string name="metamap_country_ec">Ecuador</string>
    <string name="metamap_country_ee">Estonia</string>
    <string name="metamap_country_eg">Egypt</string>
    <string name="metamap_country_er">Eritrea</string>
    <string name="metamap_country_es">Spain</string>
    <string name="metamap_country_et">Ethiopia</string>
    <string name="metamap_country_fi">Finland</string>
    <string name="metamap_country_fj">Fiji</string>
    <string name="metamap_country_fr">France</string>
    <string name="metamap_country_ga">Gabon</string>
    <string name="metamap_country_gb">United Kingdom</string>
    <string name="metamap_country_gd">Grenada</string>
    <string name="metamap_country_ge">Georgia</string>
    <string name="metamap_country_gh">Ghana</string>
    <string name="metamap_country_gm">Gambia</string>
    <string name="metamap_country_gn">Guinea</string>
    <string name="metamap_country_gq">Equatorial Guinea</string>
    <string name="metamap_country_gr">Greece</string>
    <string name="metamap_country_gt">Guatemala</string>
    <string name="metamap_country_gu">Guam</string>
    <string name="metamap_country_gw">Guinea-Bissau</string>
    <string name="metamap_country_gy">Guyana</string>
    <string name="metamap_country_hk">Hong Kong SAR China</string>
    <string name="metamap_country_hn">Honduras</string>
    <string name="metamap_country_hr">Croatia</string>
    <string name="metamap_country_ht">Haiti</string>
    <string name="metamap_country_hu">Hungary</string>
    <string name="metamap_country_id">Indonesia</string>
    <string name="metamap_country_ie">Ireland</string>
    <string name="metamap_country_il">Israel</string>
    <string name="metamap_country_in">India</string>
    <string name="metamap_country_iq">Iraq</string>
    <string name="metamap_country_ir">Iran</string>
    <string name="metamap_country_is">Iceland</string>
    <string name="metamap_country_it">Italy</string>
    <string name="metamap_country_jm">Jamaica</string>
    <string name="metamap_country_jo">Jordan</string>
    <string name="metamap_country_jp">Japan</string>
    <string name="metamap_country_ke">Kenya</string>
    <string name="metamap_country_kg">Kyrgyzstan</string>
    <string name="metamap_country_kh">Cambodia</string>
    <string name="metamap_country_ki">Kiribati</string>
    <string name="metamap_country_km">Comoros</string>
    <string name="metamap_country_kn">St. Kitts &amp; Nevis</string>
    <string name="metamap_country_kp">North Korea</string>
    <string name="metamap_country_kr">South Korea</string>
    <string name="metamap_country_kw">Kuwait</string>
    <string name="metamap_country_ky">Cayman Islands</string>
    <string name="metamap_country_kz">Kazakhstan</string>
    <string name="metamap_country_la">Laos</string>
    <string name="metamap_country_lb">Lebanon</string>
    <string name="metamap_country_lc">St. Lucia</string>
    <string name="metamap_country_li">Liechtenstein</string>
    <string name="metamap_country_lk">Sri Lanka</string>
    <string name="metamap_country_lr">Liberia</string>
    <string name="metamap_country_ls">Lesotho</string>
    <string name="metamap_country_lt">Lithuania</string>
    <string name="metamap_country_lu">Luxembourg</string>
    <string name="metamap_country_lv">Latvia</string>
    <string name="metamap_country_ly">Libya</string>
    <string name="metamap_country_ma">Morocco</string>
    <string name="metamap_country_mc">Monaco</string>
    <string name="metamap_country_md">Moldova</string>
    <string name="metamap_country_me">Montenegro</string>
    <string name="metamap_country_mf">Saint Marteen</string>
    <string name="metamap_country_mg">Madagascar</string>
    <string name="metamap_country_mk">Macedonia</string>
    <string name="metamap_country_ml">Mali</string>
    <string name="metamap_country_mm">Myanmar (Burma)</string>
    <string name="metamap_country_mn">Mongolia</string>
    <string name="metamap_country_mo">Macau</string>
    <string name="metamap_country_mp">Northern Mariana Islands</string>
    <string name="metamap_country_mr">Mauritania</string>
    <string name="metamap_country_mt">Malta</string>
    <string name="metamap_country_mu">Mauritius</string>
    <string name="metamap_country_mv">Maldives</string>
    <string name="metamap_country_mw">Malawi</string>
    <string name="metamap_country_mx">Mexico</string>
    <string name="metamap_country_my">Malaysia</string>
    <string name="metamap_country_mz">Mozambique</string>
    <string name="metamap_country_na">Namibia</string>
    <string name="metamap_country_ne">Niger</string>
    <string name="metamap_country_ng">Nigeria</string>
    <string name="metamap_country_ni">Nicaragua</string>
    <string name="metamap_country_nl">Netherlands</string>
    <string name="metamap_country_no">Norway</string>
    <string name="metamap_country_np">Nepal</string>
    <string name="metamap_country_nr">Nauru</string>
    <string name="metamap_country_nu">Niue</string>
    <string name="metamap_country_nz">New Zealand</string>
    <string name="metamap_country_om">Oman</string>
    <string name="metamap_country_pa">Panama</string>
    <string name="metamap_country_pe">Peru</string>
    <string name="metamap_country_pg">Papua New Guinea</string>
    <string name="metamap_country_ph">Philippines</string>
    <string name="metamap_country_pk">Pakistan</string>
    <string name="metamap_country_pl">Poland</string>
    <string name="metamap_country_pr">Puerto Rico</string>
    <string name="metamap_country_ps">Palestinian Territories</string>
    <string name="metamap_country_pt">Portugal</string>
    <string name="metamap_country_py">Paraguay</string>
    <string name="metamap_country_qa">Qatar</string>
    <string name="metamap_country_ro">Romania</string>
    <string name="metamap_country_rs">Serbia</string>
    <string name="metamap_country_ru">Russia</string>
    <string name="metamap_country_rw">Rwanda</string>
    <string name="metamap_country_sa">Saudi Arabia</string>
    <string name="metamap_country_sb">Solomon Islands</string>
    <string name="metamap_country_sc">Seychelles</string>
    <string name="metamap_country_sd">Sudan</string>
    <string name="metamap_country_se">Sweden</string>
    <string name="metamap_country_sg">Singapore</string>
    <string name="metamap_country_si">Slovenia</string>
    <string name="metamap_country_sk">Slovakia</string>
    <string name="metamap_country_sl">Sierra Leone</string>
    <string name="metamap_country_sm">San Marino</string>
    <string name="metamap_country_sn">Senegal</string>
    <string name="metamap_country_so">Somalia</string>
    <string name="metamap_country_sr">Suriname</string>
    <string name="metamap_country_ss">South Sudan</string>
    <string name="metamap_country_st">São Tomé &amp; Príncipe</string>
    <string name="metamap_country_sv">El Salvador</string>
    <string name="metamap_country_sy">Syria</string>
    <string name="metamap_country_sz">Swaziland</string>
    <string name="metamap_country_tc">Turks and Caicos</string>
    <string name="metamap_country_td">Chad</string>
    <string name="metamap_country_tg">Togo</string>
    <string name="metamap_country_th">Thailand</string>
    <string name="metamap_country_tj">Tajikistan</string>
    <string name="metamap_country_tl">Timor-Leste</string>
    <string name="metamap_country_tm">Turkmenistan</string>
    <string name="metamap_country_tn">Tunisia</string>
    <string name="metamap_country_to">Tonga</string>
    <string name="metamap_country_tr">Turkey</string>
    <string name="metamap_country_tt">Trinidad &amp; Tobago</string>
    <string name="metamap_country_tv">Tuvalu</string>
    <string name="metamap_country_tw">Taiwan</string>
    <string name="metamap_country_tz">Tanzania</string>
    <string name="metamap_country_ua">Ukraine</string>
    <string name="metamap_country_ug">Uganda</string>
    <string name="metamap_country_us">United States</string>
    <string name="metamap_country_uy">Uruguay</string>
    <string name="metamap_country_uz">Uzbekistan</string>
    <string name="metamap_country_va">Vatican City</string>
    <string name="metamap_country_vc">Saint Vincent and the Grenadines</string>
    <string name="metamap_country_ve">Venezuela</string>
    <string name="metamap_country_vi">Virgin Islands (U.S.)</string>
    <string name="metamap_country_vn">Vietnam</string>
    <string name="metamap_country_vu">Vanuatu</string>
    <string name="metamap_country_ws">Samoa</string>
    <string name="metamap_country_xk">Kosovo</string>
    <string name="metamap_country_ye">Yemen</string>
    <string name="metamap_country_yt">Mayotte</string>
    <string name="metamap_country_za">South Africa</string>
    <string name="metamap_country_zm">Zambia</string>
    <string name="metamap_country_zw">Zimbabwe</string>
    <string name="metamap_cpf_button_skip_submit">Skip &amp; Submit</string>
    <string name="metamap_cpf_button_submit">Submit</string>
    <string name="metamap_cpf_dialog_button">Yes, Submit</string>
    <string name="metamap_cpf_dialog_description">If CPF number is not found on your card, your verification would be rejected.</string>
    <string name="metamap_cpf_dialog_title">Are you sure?</string>
    <string name="metamap_cpf_requirement_description">Enter CPF Number (If not printed on card)</string>
    <string formatted="false" name="metamap_credit_check_text_label">I hereby expressly authorize %s to carry out the necessary investigations into my behavior and credit history with the Credit Information Systems (SCR) that I deem appropriate.\n\nI declare that these terms are in accordance with Law No. 12,414, of June 9, 2011, which governs the formation and consultation of databases with performance information, of natural persons or legal entities, for the formation of a history of credit.\n\nThese Terms and Conditions of Use and Privacy Policy and other Mati documents are in accordance with the Consumer Defense Code, the Marco Civil da Internet and the Bank Secrecy Law.\nLikewise, I declare that I am familiar with the nature and scope of credit reporting companies and the information contained in credit reports and special credit reports; I declare that I am aware of the nature and scope of the information that will be requested, the use that %s will make of such information, and that %s may make periodic inquiries about my history or that of the company I represent, consenting that this authorization is valid for a period of 5 years from its issuance and, in any case, for as long as the legal relationship is maintained.\n\nSpecific User Information\n\n1. This section specifies what information must be made available by Users and verified by Paketá Consignado upon registration of Users and in preparation for private payroll loan operations, an opportunity in which other documents and information may be requested, including for the purposes of credit analysis of the Borrower, as well as to carry out know-your-client and anti-money laundering procedures.\n2. All the information required is in accordance with the provisions of Complementary Law No. 105 of January 10, 2001, which provides for the secrecy of the operations of financial institutions.\n3. These Terms and Conditions of Use and Privacy Policy and other documents of Paketá Consignado are in accordance with the Consumer Defense Code, the Marco Civil da Internet and the Banking Secrecy Law.\n4. You warrant that all information you provide on the Paketá Digital Platform is true and accurate in all respects. You will let us know if any of the information you provide is changed or updated. Paketá\'s Digital Platform is not responsible for any non-true or outdated information provided by Users.\n\nInformation we collect exclusively from Borrowers\n\nYou are aware and hereby agree that the credit analysis and placement of your request on Paketá\'s Digital Platform depends on various information provided by the Borrower, such as requested amount, estimated period in months for payment, intended use of the requested credit , and Borrower\'s history. To determine this information, the Borrower must provide the following information and, hereby, you agree that Paketá Consignado may collect, store, process and use the following information for the purposes set out in these Terms and Conditions of Use and Policy of Privacy:\n\n1. full name;\n2. CPF;\n3. RG, issuing agency and issue status;\n4. birth date;\n5. child number;\n6. marital status;\n7. Bank data;\n8. professional data such as date of admission, gross salary, net salary and company where you work;\n9. selfie, that is, a face photo of you;\n10. front and back photo of the identification document (RG or CNH);\n11. photo of proof of income;\n12. photo of proof of address;\n13. home phone number, cell phone number and email address;\n14. full home address;\n15. chosen access password;\n16. electronically signed bank credit card;\n17. messages exchanged with Paketá\'s Digital Platform via email or in-app push;\n18. comments and any other information made available in the discussion groups and social networks of the Paketá Digital Platform;\n19. information regarding the services requested and activities carried out on the Paketá Digital Platform.</string>
    <string name="metamap_credit_check_title_label">Credit Check consent</string>
    <string name="metamap_customInput_taxpayerNumber_error_invalidCPF">Please enter a valid CPF number</string>
    <string name="metamap_custom_input_title">Enter your details</string>
    <string name="metamap_document_photo_blurry_title">Document photo is too blurry</string>
    <string name="metamap_document_too_small_title">Document photo has too small resolution.</string>
    <string name="metamap_e_sign_attach_document">Please attach contract document to verification flow.</string>
    <string name="metamap_e_sign_uploadDocument_massage">Please upload document</string>
    <string name="metamap_email_error_resend_locked">Please, wait a while to resend additional code</string>
    <string name="metamap_enable_location_desc">Enabling Location Services will help us determine your location accurately! Please click on ‘Allow location access’ to proceed.</string>
    <string name="metamap_error_attempts_to_enter_code_have_been_exhausted">Attempts to enter the code have been exhausted. However, you can try sending another code.</string>
    <string name="metamap_error_desc_biometric_mask_detected">Make sure your entire face is visible</string>
    <string name="metamap_error_description_email_confirmation_code_too_many_attempts">Attempts to enter the code have been exhausted. However, you can try sending another code.</string>
    <string name="metamap_error_description_email_resend_locked">Unable to resend the code now. Please try again later</string>
    <string name="metamap_error_description_invalid_email">The format of email you\'ve entered is wrong</string>
    <string name="metamap_error_description_too_many_resends">Attempts to re-send Email have been exhausted</string>
    <string name="metamap_error_description_wrong_email_confirmation_code">The confirmation code you\'ve entered was wrong</string>
    <string name="metamap_error_invalid_phone_number">Invalid phone number format</string>
    <string name="metamap_error_message_email_verification">This code is incorrect</string>
    <string name="metamap_error_message_wrong_multi_custom_doc_file_format">Invalid file: the document must be a PDF</string>
    <string name="metamap_error_pdf_transformation">Cannot convert pdf file</string>
    <string name="metamap_error_title_biometric_mask_detected">Please remove your mask</string>
    <string name="metamap_error_title_email_confirmation_code_too_many_attempts">Too many attempts</string>
    <string name="metamap_error_title_email_resend_locked">Resend locked</string>
    <string name="metamap_error_title_invalid_email">Invalid email</string>
    <string name="metamap_error_title_too_many_resends">Too many resends</string>
    <string name="metamap_error_title_wrong_email_confirmation_code">Wrong confirmation code</string>
    <string name="metamap_error_too_small_image_title">Image is too small</string>
    <string name="metamap_face_detection_title_label">Sorry, we can\'t detect face in center of frame</string>
    <string name="metamap_face_not_detected_selfie_description">We cannot detect your face. Position your face in the centre &amp; retry </string>
    <string name="metamap_face_not_detected_selfie_error">Face not detected</string>
    <string name="metamap_grant_location_access">Grant Location Access</string>
    <string name="metamap_hardware_error_desc">Could not open the camera</string>
    <string name="metamap_hardware_error_heading">Hardware error</string>
    <string name="metamap_hint_email_submission_fragment">Please enter your email</string>
    <string name="metamap_invalid_email_error_message_email_submission_fragment">The email is invalid. Please try another one</string>
    <string name="metamap_label_accept">Accept</string>
    <string name="metamap_label_agreement">By clicking the Start button you agree to our User Terms and Conditions and our Privacy Notice.</string>
    <string name="metamap_label_ai_now_analyzing_selfie">Our AI is now analyzing your biometric step submission</string>
    <string name="metamap_label_ai_now_analyzing_video">Our AI is now analyzing your biometric step submission</string>
    <string name="metamap_label_allow_access">Allow access</string>
    <string name="metamap_label_allow_access_your_camera">Please allow us to access your camera in settings to continue your verification flow.</string>
    <string name="metamap_label_and">And</string>
    <string name="metamap_label_attachFile_title">Attach a file</string>
    <string name="metamap_label_attach_file">Attach file</string>
    <string name="metamap_label_back_side">Back Side</string>
    <string name="metamap_label_bank_statement">Bank Statement</string>
    <string name="metamap_label_biometricVerification_title">The media you are recording will be used as a part of an electronic signature process</string>
    <string name="metamap_label_biometric_face_not_detected">We were not able to detect your face</string>
    <string name="metamap_label_biometric_found_issues">Issues were found with your video</string>
    <string name="metamap_label_biometric_step">Biometric Step</string>
    <string name="metamap_label_cancel">Cancel</string>
    <string name="metamap_label_cancel_button">Cancel</string>
    <string name="metamap_label_cannot_access_camera">We cannot access your camera</string>
    <string name="metamap_label_check_your_internet">Please check your internet</string>
    <string name="metamap_label_choose">Choose</string>
    <string name="metamap_label_choose_your_language">Select a language</string>
    <string name="metamap_label_close">Close</string>
    <string name="metamap_label_congrats">Congrats! Your verification is complete.</string>
    <string name="metamap_label_continue">Continue</string>
    <string name="metamap_label_continue_verification">Continue Verification</string>
    <string name="metamap_label_country">Country</string>
    <string name="metamap_label_country_mismatch_error_description">This type of document or this country is not accepted.</string>
    <string name="metamap_label_country_mismatch_error_title">You uploaded an unacceptable document</string>
    <string name="metamap_label_did_not_look_at_camera">You look at the camera</string>
    <string name="metamap_label_did_not_make_circles">You make 2 head circles</string>
    <string name="metamap_label_did_you_make_circles">Did you make 2 head circles?</string>
    <string name="metamap_label_doc_face_not_detected">No face was found on your document</string>
    <string name="metamap_label_doc_text_not_detected">We did not detect any text in your document</string>
    <string name="metamap_label_document_badText_error_description">Make sure your document is well lit without any glare or reflections</string>
    <string name="metamap_label_document_badText_error_title">Information could not be read</string>
    <string name="metamap_label_document_blurryText_error_description">Make sure your document’s image is not blurred</string>
    <string name="metamap_label_document_blurryText_error_title">Information could not be read</string>
    <string name="metamap_label_document_countryMismatch_error_description">Please upload a document from the selected country</string>
    <string name="metamap_label_document_countryMismatch_error_title">Country and document mismatch</string>
    <string name="metamap_label_document_image_cropped_error_description">Please make sure all the edges of the document are captured within the frame</string>
    <string name="metamap_label_document_image_cropped_error_title">Document’s Image cropped</string>
    <string name="metamap_label_document_mrz_error_description">Please make sure all the edges of the document are captured within the frame</string>
    <string name="metamap_label_document_noFace_error_description">Please make sure your face in the document is clearly visible</string>
    <string name="metamap_label_document_noFace_error_title">No face found on your document</string>
    <string name="metamap_label_document_step">Document step</string>
    <string name="metamap_label_document_typeMismatch_error_description">Please upload the correct document</string>
    <string name="metamap_label_document_typeMismatch_error_title">Incorrect document type</string>
    <string name="metamap_label_done">Done</string>
    <string name="metamap_label_drivers_license">Driver’s License</string>
    <string name="metamap_label_email_validation_action">Enter your email address</string>
    <string name="metamap_label_enter_code">Enter code</string>
    <string name="metamap_label_error_creds_title">Something went wrong, please check your settings or internet connection</string>
    <string name="metamap_label_error_vl_noface">We didn’t detect a face in your video</string>
    <string name="metamap_label_error_vl_noface_description">Please try again. Make sure your face is well lit and in the center of the image.</string>
    <string name="metamap_label_error_vl_timeout">You\'ve timed out due to inactivity!</string>
    <string name="metamap_label_exit">Exit</string>
    <string name="metamap_label_fetching_location">Fetching your location...</string>
    <string name="metamap_label_file_button">File</string>
    <string name="metamap_label_finish">Finish</string>
    <string name="metamap_label_front_side">Front Side</string>
    <string name="metamap_label_full_name_placeholder">Full Name</string>
    <string name="metamap_label_gallery">Gallery</string>
    <string name="metamap_label_go_to_settings">Go to settings</string>
    <string name="metamap_label_i_confirm">I confirm</string>
    <string name="metamap_label_ip_description">We are sorry, but the service you are trying\nto access is not available in your region.</string>
    <string name="metamap_label_ip_description_optional">Usage of the service in your region\ncould have some limitations.</string>
    <string name="metamap_label_ip_title">Restricted</string>
    <string name="metamap_label_is_photo_clear">Is the photo clear? Make sure it is not blurry and there are no reflections or flash.</string>
    <string name="metamap_label_is_selfie_clear_and_not_blurry">Is your selfie clear and not blurry?</string>
    <string name="metamap_label_large_image_error">The image is too large</string>
    <string name="metamap_label_loading_liveness_title">Our AI is checking your video</string>
    <string name="metamap_label_location_validation_action">Verify Your Location</string>
    <string name="metamap_label_make_circles_with_nose">Make 2 circles with your head</string>
    <string name="metamap_label_make_sure_face_is_visible">Your document should be well lit, without any reflections</string>
    <string name="metamap_label_make_sure_picture_is_clear">Please try again and make sure the picture is clear</string>
    <string name="metamap_label_make_sure_you_own_id">Let\'s make sure you own the ID</string>
    <string name="metamap_label_national_id">National ID</string>
    <string name="metamap_label_next">Next</string>
    <string name="metamap_label_no_internet_connection_title">No internet connection</string>
    <string name="metamap_label_no_retake">No, retake</string>
    <string name="metamap_label_nodocument_error_description">Make sure the document is in focus and all its parts are visible on the image</string>
    <string name="metamap_label_nodocument_error_title">Not all data could be read</string>
    <string name="metamap_label_noface_descr_document_error">Please try again. Make sure your face is well-lit and in the center of the image.</string>
    <string name="metamap_label_noface_document_error">No face was found on your document</string>
    <string name="metamap_label_notext_descr_document_error">Your document should be well lit, without any glare or reflections</string>
    <string name="metamap_label_notext_document_error">Not all fields could be read</string>
    <string name="metamap_label_of">of</string>
    <string name="metamap_label_old_agreement">By clicking the \"Start\" button you agree to our User Terms and Conditions</string>
    <string name="metamap_label_openPDF">Open PDF</string>
    <string name="metamap_label_or">Or</string>
    <string name="metamap_label_otp_success">OTP was sent successfully!</string>
    <string name="metamap_label_out_of_space_error_description">Please free space for video recording</string>
    <string name="metamap_label_out_of_space_error_title">Storage out of space</string>
    <string name="metamap_label_page">Page</string>
    <string name="metamap_label_part_of_esign_liveness">The media you are recording will be used as a part of an electronic signature process</string>
    <string name="metamap_label_passport">Passport</string>
    <string name="metamap_label_pdf_transformation_failed">Pdf file transformation failed. Please try with other file. </string>
    <string name="metamap_label_photolibrary_button">Photo library</string>
    <string name="metamap_label_physical_error_description">Photos of screen or modified documents,\nphotos of printed copies (colour or black and white),\nwill result in your profile not being approved</string>
    <string name="metamap_label_physical_error_title">Please take a photo of your original physical document</string>
    <string name="metamap_label_please_confirm_documents_available">Please confirm you have actual documents or their images available on your device.</string>
    <string name="metamap_label_por_document_bills_descr">Gas, Water, Electricity, Internet,\nPhone or Bank Statement</string>
    <string name="metamap_label_por_document_bills_title">Utility company bills</string>
    <string name="metamap_label_por_document_contains_descr">- Your name\n- Address\n- Name of the company\n- Date of issue</string>
    <string name="metamap_label_por_document_contains_title">Must contain:</string>
    <string name="metamap_label_por_document_validity">Must not be older than</string>
    <string name="metamap_label_por_type_hint_title">Must contain:</string>
    <string name="metamap_label_position_your_face_in_center">Position your face in the center of the frame and take a selfie</string>
    <string name="metamap_label_poweredby">Powered by</string>
    <string name="metamap_label_privacy_notice">Privacy Notice</string>
    <string name="metamap_label_proof_of_address">Proof of Address</string>
    <string name="metamap_label_provide_following_documents">We will need you to provide the following documents:</string>
    <string name="metamap_label_provide_one_of_these_documents">We will need you to provide one of these documents:</string>
    <string name="metamap_label_record_a_short_selfie_video">Record a short selfie video</string>
    <string name="metamap_label_repeat_biometric_test">Repeat the biometric test</string>
    <string name="metamap_label_resend">Resend</string>
    <string name="metamap_label_retry">Retry</string>
    <string name="metamap_label_search">Search</string>
    <string name="metamap_label_select_country">Select country</string>
    <string name="metamap_label_select_country_of_document">Select country of document</string>
    <string name="metamap_label_select_document">Select Document</string>
    <string name="metamap_label_select_image_larger_then">Please select an image that is at least 600x600 pixels</string>
    <string name="metamap_label_select_image_smaller_then">Please select an image smaller than 15 MB</string>
    <string name="metamap_label_select_language">Select Language</string>
    <string name="metamap_label_select_province">Select Province</string>
    <string name="metamap_label_select_state_of_document">Select the state of your document</string>
    <string name="metamap_label_selected_image_decoding_error">Image could not be read, please select another one</string>
    <string name="metamap_label_selfie">Selfie</string>
    <string name="metamap_label_selfie_step_description">In this step you will take a selfie photo. If you have glasses, please take them off.</string>
    <string name="metamap_label_selfie_video_step">Selfie video with 2 head circles</string>
    <string name="metamap_label_server_error_description">We experience temporary issues with processing user verifications. Please try again in 15 minutes</string>
    <string name="metamap_label_server_error_title">Server Error</string>
    <string name="metamap_label_sign">Sign</string>
    <string name="metamap_label_signature_centerTitle">Read and type your name to sign</string>
    <string name="metamap_label_signature_description">By typing your full name and clicking on Sign you agree to the terms described above and to the use of a biometric signature as a form of consent.</string>
    <string name="metamap_label_signature_first_description">Read carefully, you will be asked to sign this document\non the further screen.</string>
    <string name="metamap_label_signature_name">Your full name</string>
    <string name="metamap_label_signature_subtitle">Before accepting scroll and read whole document</string>
    <string name="metamap_label_signature_title">Please read carefully</string>
    <string name="metamap_label_skip">Skip</string>
    <string name="metamap_label_skip_cutomDocument">I don’t have my document at hand</string>
    <string name="metamap_label_small_image_error">Your image is too small</string>
    <string name="metamap_label_sms_check_action">Enter your phone number</string>
    <string name="metamap_label_sms_check_button">Send SMS</string>
    <string name="metamap_label_sms_check_code_incorrect">This code is incorrect</string>
    <string name="metamap_label_sms_check_noattemps">Attempts to re-send SMS have been exhausted</string>
    <string name="metamap_label_sms_check_resend">Your code will be valid for 10 min.\nResend code in %1$s</string>
    <string name="metamap_label_sms_check_resend_button">Resend</string>
    <string name="metamap_label_sms_check_sent">Enter the code sent to</string>
    <string name="metamap_label_sms_check_title">Phone validation</string>
    <string name="metamap_label_something_went_wrong">Something went wrong</string>
    <string name="metamap_label_start">Start</string>
    <string name="metamap_label_step_can_take_little_longer">This step can sometimes take a little longer</string>
    <string name="metamap_label_stop">Stop</string>
    <string name="metamap_label_take_a_selfie">Take a Selfie</string>
    <string name="metamap_label_take_photo">Take a photo</string>
    <string name="metamap_label_this_happened_because">Make sure that:</string>
    <string name="metamap_label_timeout">Time out</string>
    <string name="metamap_label_to_get_verified_you_will_need_to">To get verified, you will need to:</string>
    <string name="metamap_label_try_again">Try Again</string>
    <string name="metamap_label_unexpected_error">We are sorry but some unexpected error just happened, please try again.</string>
    <string name="metamap_label_unsaved_changes">You will have to restart the verification</string>
    <string name="metamap_label_unsupported_api">Unsupported API Version</string>
    <string name="metamap_label_upload_photos_proving_your_identity">Upload photos of documents proving your identity</string>
    <string name="metamap_label_upload_successful">Upload Successful</string>
    <string name="metamap_label_uploading">Uploading</string>
    <string name="metamap_label_uploading_selfie">Uploading selfie</string>
    <string name="metamap_label_uploading_video">Uploading video</string>
    <string name="metamap_label_uploading_your">Uploading your</string>
    <string name="metamap_label_user_terms">Mati\'s User Terms of Service</string>
    <string name="metamap_label_user_terms_and_cond">User Terms and Conditions</string>
    <string name="metamap_label_user_terms_and_privacy_notice">User Terms and Conditions and our Privacy Notice</string>
    <string name="metamap_label_utility_bill">Utility Bill (Gas, Electricity, Water, etc.)</string>
    <string name="metamap_label_verify_me">Verify me</string>
    <string name="metamap_label_verify_your_identity">Let\'s verify your identity</string>
    <string name="metamap_label_version_not_supported">The current version of your application is not supported.</string>
    <string name="metamap_label_video">Video</string>
    <string name="metamap_label_video_step_another">Record another video</string>
    <string name="metamap_label_video_step_description">Make sure your face is well lit</string>
    <string name="metamap_label_voiceliveness_title">Record a video and say the digits</string>
    <string name="metamap_label_vpn_description">We detected you are using a proxy or VPN service.\nPlease disable it and try again.</string>
    <string name="metamap_label_vpn_description_optional">We detected you are using a proxy or VPN service.\nPlease disable it to avoid issues with verification.</string>
    <string name="metamap_label_vpn_title">VPN detected</string>
    <string name="metamap_label_want_to_exit">Are you sure you want to leave?</string>
    <string name="metamap_label_want_to_exit_newmay">Why are you leaving the verification?</string>
    <string name="metamap_label_want_to_exit_no_document">I don\'t have the document with me</string>
    <string name="metamap_label_want_to_exit_smth_else">It\'s something else</string>
    <string name="metamap_label_want_to_exit_wont_upload">I don\'t want to upload the document</string>
    <string name="metamap_label_want_to_leave_verification">Are you sure you want to leave verification?</string>
    <string name="metamap_label_we_supported_these_languages">We have fully supported these languages</string>
    <string name="metamap_label_went_to_fast">You go slowly</string>
    <string name="metamap_label_yes_i_did_two_circles">Yes, upload</string>
    <string name="metamap_label_yes_picture_is_clear">Yes, picture is clear</string>
    <string name="metamap_label_yes_selfie_is_clear">Yes, selfie is clear</string>
    <string name="metamap_label_you_are_done">Verification data received. Click done to continue.</string>
    <string name="metamap_label_you_will_lose_all_uploaded_information">In this case you will lose all uploaded information</string>
    <string name="metamap_lable_ok">OK</string>
    <string name="metamap_lable_open_setings_app">1. Open the Settings app</string>
    <string name="metamap_lable_select_locaiton_services">3. Select Location Services</string>
    <string name="metamap_lable_select_privacy">2. Select “Privacy”</string>
    <string name="metamap_lable_trun_on_location_services">4. Turn on Location Services</string>
    <string name="metamap_location_disabled_desc">To get the best possible verification experience, you may want to enable location tracking for this app. Click below to proceed.</string>
    <string name="metamap_location_disabled_desc_never_ask_again">We couldn\'t access your location.\nTo get the best possible verification experience, you may want to enable location tracking for this app. Open Location Settings by clicking the button below.</string>
    <string name="metamap_location_fetch_timeout_error_screen_heading">Please move to a more reachable area.</string>
    <string name="metamap_location_fetch_timeout_error_screen_message">To proceed with the verification, please move to an area where a stable GPS signal can be established. Cities with narrow streets or buildings with thick walls make it difficult to do so.</string>
    <string name="metamap_location_intelligence_gps_dialog_message">For better experience, turn on device location which uses location service</string>
    <string name="metamap_location_not_enabled">Location services are not enabled</string>
    <string name="metamap_location_service_off_popup_title">Turn on Location Services  for your iPhone</string>
    <string name="metamap_location_service_off_popup_title_for_iPad">Turn on Location Services  for your iPad</string>
    <string name="metamap_metamap_customInput_taxpayerNumber_placeholder">Enter 11 digit CPF Number</string>
    <string name="metamap_no_face_detection_document_title">No faces detected on document photo</string>
    <string name="metamap_open_location_settings">Open Location Settings</string>
    <string name="metamap_payroll_account_title">Payroll account data</string>
    <string name="metamap_please_allow_location_access">Please allow location access</string>
    <string name="metamap_por_options_selector_hint">Choose a document</string>
    <string name="metamap_por_warning_label">Must be not older than</string>
    <string name="metamap_primary_action_title_email_submission_fragment">Send email</string>
    <string name="metamap_proceed_without_location">Proceed without location tracking</string>
    <string name="metamap_select_por_first_hint">Your current address</string>
    <string name="metamap_select_por_fourth_hint">Issuance date</string>
    <string name="metamap_select_por_second_hint_bank_statement">Name of the bank</string>
    <string name="metamap_select_por_second_hint_utility_bill">Name of the bill provider</string>
    <string name="metamap_select_por_third_hint">Your Name</string>
    <string name="metamap_selfieVideoSteps_mobileStart_button">Start recording</string>
    <string name="metamap_selfieVideoSteps_record_description">Make 2 circles with your head</string>
    <string name="metamap_skip_back_alert_button_text">Yes, Skip</string>
    <string name="metamap_skip_back_alert_description">Are you sure there is no personal information on the back side of the document? \n\n False declaration can lead to rejection!</string>
    <string name="metamap_skip_step">Skip this step</string>
    <string name="metamap_subtitle_camera_permission_denied">We need to access a camera for taking photos or recording videos. You can grant access from settings.</string>
    <string name="metamap_subtitle_email_submission_fragment">Enter your email</string>
    <string name="metamap_subtitle_microphone_permission_denied">We need access to microphone for recording videos. You can grant access from settings.</string>
    <string name="metamap_subtitle_prefix_email_verification">Enter the code sent to</string>
    <string name="metamap_thankyou_providing_location">Thank you for providing location access!</string>
    <string name="metamap_title_camera_permission_denied">Camera Permission needed</string>
    <string name="metamap_title_email_submission_fragment">Email validation</string>
    <string name="metamap_title_english">English</string>
    <string name="metamap_title_french">Français</string>
    <string name="metamap_title_german">Deutsch</string>
    <string name="metamap_title_italian">Italiano</string>
    <string name="metamap_title_microphone_permission_denied">Microphone permission needed</string>
    <string name="metamap_title_polish">Polski</string>
    <string name="metamap_title_portuguese">Português</string>
    <string name="metamap_title_russian">Русский</string>
    <string name="metamap_title_spanish">Español</string>
    <string name="metamap_title_thai">ภาษาไทย</string>
    <string name="metamap_title_turkish">Türkçe</string>
    <string name="metamap_unexpected_error_document_title">Unexpected error in document reading happened.</string>
    <string name="metamap_work_account_title">Work Account Data</string>
    ...
    <style name="BottomProgressBar">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_marginBottom">@dimen/_28sdp</item>
    </style>
    <style name="Button.Main" parent="Widget.MaterialComponents.Button.UnelevatedButton">
        <item name="android:letterSpacing">0</item>
        <item name="android:insetTop">0dp</item>
        <item name="android:insetBottom">0dp</item>
        <item name="iconTint">@null</item>
        <item name="isPrimary">true</item>
        <item name="iconGravity">textStart</item>
        <item name="android:fontFamily">@font/lato_bold</item>
        <item name="android:textSize">@dimen/_12ssp</item>
        <item name="android:backgroundTint">@null</item>
        <item name="android:theme">@style/MetamapMaterialButton.Theme</item>
        <item name="android:minHeight">@dimen/_40sdp</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
        <item name="android:layout_marginBottom">@dimen/_8sdp</item>
        <item name="android:gravity">center</item>
    ...
    <style name="Button.SecondaryNew" parent="Widget.MaterialComponents.Button.OutlinedButton">
        <item name="iconTint">@null</item>
        <item name="android:letterSpacing">0</item>
        <item name="android:insetTop">0dp</item>
        <item name="android:insetBottom">0dp</item>
        <item name="strokeWidth">@dimen/_1sdp</item>
        <item name="strokeColor">@color/metamap_secondary_text</item>
        <item name="iconGravity">textStart</item>
        <item name="android:theme">@style/MetamapMaterialButton.Theme</item>
        <item name="android:backgroundTint">@null</item>
        <item name="android:fontFamily">@font/lato_bold</item>
    ...
    <style name="CaptureAction">
        <item name="android:layout_width">@dimen/_48sdp</item>
        <item name="android:layout_height">@dimen/_48sdp</item>
        <item name="android:layout_marginBottom">@dimen/_32sdp</item>
    </style>
    <style name="CaptureSecondaryAction">
        <item name="android:layout_width">@dimen/_24sdp</item>
        <item name="android:layout_height">@dimen/_24sdp</item>
        <item name="android:layout_marginStart">@dimen/_32sdp</item>
        <item name="android:layout_marginEnd">@dimen/_32sdp</item>
    </style>
    ...
    <style name="ContainerDark">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">match_parent</item>
        <item name="android:theme">@style/MetamapTheme.Dark</item>
    </style>
    <style name="ContainerLight">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">match_parent</item>
        <item name="android:theme">@style/MetamapTheme.Light</item>
    </style>
    <style name="CpfEditText">
        <item name="android:fontFamily">@font/lato_regular</item>
        <item name="android:layout_width">0dp</item>
        <item name="android:layout_height">@dimen/_36sdp</item>
        <item name="android:background">@drawable/metamap_bg_et_cpf_normal</item>
        <item name="android:cursorVisible">false</item>
        <item name="android:gravity">center</item>
        <item name="android:inputType">number</item>
        <item name="android:maxLength">3</item>
        <item name="android:textColorHint">@color/metamap_cpf_et_hint_color</item>
    </style>
    <style name="MainIcon">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">@dimen/_120sdp</item>
        <item name="android:adjustViewBounds">true</item>
    </style>
    <style name="MetamapMaterialButton.Theme" parent="Theme.MaterialComponents.Light.NoActionBar">
        <item name="colorAccent">@color/metamap_color_accent</item>
        <item name="colorSecondary">@color/metamap_color_red</item>
        <item name="colorPrimary">@color/metamap_darkGray</item>
        <item name="android:textColorSecondary">@color/metamap_secondary_text</item>
    </style>
    <style name="MetamapTheme.Dark" parent="Theme.AppCompat.NoActionBar">
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowBackground">@color/metamap_background_color_dark</item>
        <item name="android:windowDrawsSystemBarBackgrounds">true</item>
        <item name="colorAccent">@color/metamap_color_accent</item>
        <item name="android:navigationBarColor">@color/metamap_background_color_dark</item>
        <item name="android:textColorPrimary">@color/metamap_primary_text_inverse</item>
        <item name="android:textColorSecondary">@color/metamap_secondary_text</item>
        <item name="android:fontFamily">@font/lato_regular</item>
    </style>
    <style name="MetamapTheme.Light" parent="Theme.AppCompat.Light.NoActionBar">
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowBackground">@color/metamap_background_color_light</item>
        <item name="android:windowDrawsSystemBarBackgrounds">true</item>
        <item name="colorAccent">@color/metamap_color_accent</item>
        <item name="android:navigationBarColor">@color/metamap_background_color_dark</item>
        <item name="android:textColorPrimary">@color/metamap_primary_text</item>
        <item name="android:textColorSecondary">@color/metamap_secondary_text</item>
        <item name="android:fontFamily">@font/lato_regular</item>

    </style>
    <style name="PassCodeView">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
        <item name="android:gravity">center</item>
        <item name="symbol_background_color">@color/metamap_background_color_light</item>
        <item name="symbol_border_color">@color/metamap_view_element</item>
        <item name="symbol_border_corner_radius">@dimen/_4sdp</item>
        <item name="symbol_border_width">@dimen/_1sdp</item>
        <item name="symbol_font_family">@font/lato_regular</item>
        <item name="symbol_height">@dimen/_56sdp</item>
        <item name="symbol_text_color">@color/metamap_view_element</item>
        <item name="symbol_text_size">@dimen/_36ssp</item>
        <item name="symbol_width">@dimen/_48sdp</item>
    </style>
    ...
    <style name="RequiredDocItemView">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        ...
        <item name="android:maxLines">2</item>
        <item name="android:textColor">@color/metamap_color_accent</item>
    ...
    <style name="StartVerificationIconBig">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">@dimen/_140sdp</item>
        <item name="android:minHeight">@dimen/_140sdp</item>
        <item name="android:adjustViewBounds">true</item>
    </style>
    <style name="StartVerificationIconMid">
        <item name="android:layout_width">@dimen/_64sdp</item>
        <item name="android:minHeight">@dimen/_64sdp</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:adjustViewBounds">true</item>
    </style>
    <style name="StartVerificationIconSmall">
        <item name="android:layout_width">@dimen/_48sdp</item>
        <item name="android:minHeight">@dimen/_48sdp</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:adjustViewBounds">true</item>
    </style>
    <style name="Text.DescNew" parent="@android:style/TextAppearance">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:textColor">?android:attr/textColorSecondary</item>
        <item name="android:textSize">@dimen/_12ssp</item>
    ...
    <style name="Text.ErrorHint" parent="@style/Text.DescNew">
        <item name="android:textColor">@color/metamap_color_red</item>
        <item name="android:gravity">start</item>
    </style>
    <style name="Text.EtInfo" parent="@style/Text.DescNew">
        <item name="android:textColor">?android:attr/textColorPrimary</item>
        <item name="android:textSize">@dimen/_10ssp</item>
        <item name="android:gravity">start</item>
        <item name="android:ellipsize">end</item>
    ...
    <style name="Text.FragmentSubtitle" parent="Text.DescNew">
        <item name="android:layout_marginTop">@dimen/_10sdp</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
    </style>
    <style name="Text.FragmentTitle" parent="Text.TitleNew">
        <item name="android:layout_marginTop">@dimen/_10sdp</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
    </style>
    <style name="Text.FragmentTitle.CaptureScreen" parent="Text.TitleNew">
        <item name="android:layout_marginBottom">@dimen/_8sdp</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
    </style>
    <style name="Text.Input" parent="@android:style/TextAppearance">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:fontFamily">@font/lato_regular</item>
        <item name="android:background">@drawable/metamap_bg_edit_text</item>
        <item name="android:paddingStart">@dimen/_8sdp</item>
        <item name="android:paddingEnd">@dimen/_8sdp</item>
        <item name="android:paddingTop">@dimen/_14sdp</item>
        <item name="android:paddingBottom">@dimen/_14sdp</item>
        <item name="android:textColor">@color/metamap_secondary_text</item>
        <item name="android:textSize">@dimen/_14ssp</item>
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
    </style>
    <style name="Text.PorHint" parent="@android:style/TextAppearance">
        <item name="android:paddingStart">@dimen/_8sdp</item>
        <item name="android:paddingEnd">@dimen/_8sdp</item>
        <item name="android:paddingTop">@dimen/_4sdp</item>
        <item name="android:paddingBottom">@dimen/_4sdp</item>
        <item name="android:fontFamily">@font/lato_regular</item>
        <item name="android:background">@drawable/metamap_bg_por_hint</item>
        <item name="android:textColor">@color/metamap_secondary_text</item>
        <item name="android:textSize">@dimen/_12ssp</item>
        <item name="android:gravity">start</item>
    </style>
    <style name="Text.Skip" parent="@android:style/TextAppearance">
        ...
        <item name="android:layout_marginBottom">@dimen/_20sdp</item>
        <item name="android:text">@string/metamap_label_skip</item>
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:fontFamily">@font/lato_regular</item>
        <item name="android:textColor">@color/metamap_secondary_text</item>
    ...
    <style name="Text.SpinnerRegular" parent="Text.SpinnerText">
        <item name="android:layout_marginStart">@dimen/_16sdp</item>
        <item name="android:layout_marginEnd">@dimen/_16sdp</item>
        <item name="android:background">@drawable/metamap_bg_new_select_country_spinner</item>
    </style>
    <style name="Text.SpinnerText" parent="@android:style/TextAppearance">
    ...
    <style name="Text.SubTitle" parent="@style/Text.DescNew">
        <item name="android:paddingStart">@dimen/_25sdp</item>
        <item name="android:paddingEnd">@dimen/_25sdp</item>
    </style>
    <style name="Text.TitleNew" parent="@android:style/TextAppearance">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:textColor">?android:attr/textColorPrimary</item>
        <item name="android:textSize">@dimen/_14ssp</item>
    ...
    <declare-styleable name="DocumentOverlayView">
        <attr format="boolean" name="showCorner"/>
    </declare-styleable>
    ...
    <declare-styleable name="MetamapIconButton">
        <attr format="boolean" name="isPrimary"/>
    </declare-styleable>
    <declare-styleable name="MetamapLoginButton">
    ...
    <declare-styleable name="PassCodeView">
        <attr format="dimension" name="symbol_width"/>
        <attr format="dimension" name="symbol_height"/>
        <attr format="string" name="symbol_font_family"/>
        <attr format="color" name="symbol_text_color"/>
        <attr format="dimension" name="symbol_text_size"/>
        <attr format="color" name="symbol_background_color"/>
        <attr format="color" name="symbol_border_color"/>
        <attr format="dimension" name="symbol_border_width"/>
        <attr format="dimension" name="symbol_border_corner_radius"/>
        <attr format="dimension" name="symbols_spacing"/>
        <attr format="integer" name="pass_code_length"/>
    </declare-styleable>
    ...
    <declare-styleable name="SplitPairRule">
        ...
        <attr format="boolean" name="finishPrimaryWithSecondary"/>
        ...
        <attr format="boolean" name="finishSecondaryWithPrimary"/>
